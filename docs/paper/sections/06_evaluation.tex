...
Peak RAM for the most demanding configuration tested (chr22, 30x WGS) is 4.21\,GB.
A full human genome at 30x is projected at ${\sim}17$\,GB, which exceeds the 12\,GB benchmark machine and requires either a higher-memory workstation or reducing \texttt{output\_buffer\_regions}.
