...
ART\autocite{huang2012art} generates reads de novo but lacks variant injection.
NEAT\autocite{stephens2016neat} supports basic SNV and indel injection but lacks tumour models, UMI simulation, and cfDNA fragmentation.
