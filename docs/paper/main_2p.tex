...
Priority next steps: (1) chi-squared VAF accuracy test; (2) cfDNA fragment distribution validation; (3) extending the variant caller benchmark to additional tools (VarDict, Strelka2, fgbio).
